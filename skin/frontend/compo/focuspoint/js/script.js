...
function loggedinusers() {
	...
	if (document.getElementById("myaccount-sub").classList.contains('active')) {
      document.getElementById("myaccount-sub").classList.remove("active");
      }
	 else { document.getElementById("myaccount-sub").classList.add("active"); }
						 
}

function loggedinusersmob() {
						 
	if (document.getElementById("myaccount-submob").classList.contains('active')) {
      document.getElementById("myaccount-submob").classList.remove("active");
      }
	 else { document.getElementById("myaccount-submob").classList.add("active"); }
						 
}



//if (document.getElementById('accordion-needhelp') !=null)  { 
//document.getElementById('accordion-needhelp').classList.remove("in");
//document.getElementById('accordion-needhelp').setAttribute('aria-expanded', 'false');

//}

function mobilecustommenu(idname) {
		
	
	
	if (document.getElementById(idname).classList.contains('in')) { 
	     document.getElementById(idname).classList.remove("in");
		 document.getElementById(idname).setAttribute('aria-expanded', 'false');
	
	 }
	 else {
		 document.getElementById(idname).classList.add("in");
		 document.getElementById(idname).setAttribute('aria-expanded', 'true');
	 }

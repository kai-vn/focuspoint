<?php
class Meigee_AjaxKit_Block_Frontend_AddToCart_Popup_CartTotal extends Mage_Core_Block_Template
{
    function __construct()
    {
        $this->setTemplate('ajaxkit/addtocart/popup/cart_total.phtml');
        parent::__construct();
    }

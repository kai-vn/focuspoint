<?php
class Meigee_AjaxKit_Block_Frontend_AddToCart_Popup_ProductList extends Mage_Core_Block_Template
{
    protected $popup_text = false;
    protected $popup_text_class = false;
    function __construct()
    {
        $this->setTemplate('ajaxkit/addtocart/popup/product_list.phtml');
        parent::__construct();
    }

<?php
class Meigee_AjaxKit_Block_Frontend_AddToCart_Popup_AdditionalProducts extends Mage_Core_Block_Template
{
    function __construct()
    {
        $this->setTemplate('ajaxkit/addtocart/popup/additional_products.phtml');
        parent::__construct();
    }
